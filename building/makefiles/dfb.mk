...
$(DFB_TARGET_DEBUG): $(DFB_OBJS_DEBUG)
	...
	$(LNK) -s -f $(DFB_TARGET_DEBUG) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG_LINK)
	$(CP) $(DFB_TARGET_DEBUG) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG_LINK)

$(DFB_TARGET_DEBUG_Z): $(DFB_OBJS_DEBUG)
	$(AR) -cru $(DFB_TARGET_DEBUG_Z) $(DFB_OBJS_DEBUG)
	$(LNK) -s -f $(DFB_TARGET_DEBUG_Z) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG_Z_LINK)
	$(CP) $(DFB_TARGET_DEBUG_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_DEBUG_Z_LINK)

$(DFB_TARGET): $(DFB_OBJS_RELEASE)
	$(LN) $(LDFLAGS) -shared -o $(DFB_TARGET) $(DFB_LIBS_DIR) $(DFB_LIBS) $(DFB_OBJS_RELEASE)
	$(LNK) -s -f $(DFB_TARGET) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(DFB_TARGET_LINK)
	$(CP) $(DFB_TARGET) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_LINK)

$(DFB_TARGET_Z): $(DFB_OBJS_RELEASE)
	$(AR) -cru $(DFB_TARGET_Z) $(DFB_OBJS_RELEASE)
	$(LNK) -s -f $(DFB_TARGET_Z) $(BASEDIR)/lib/$(EPROSIMA_TARGET)/$(DFB_TARGET_Z_LINK)
	$(CP) $(DFB_TARGET_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)
	$(LNK) -s -f $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_Z) $(EPROSIMA_LIBRARY_PATH)/proyectos/$(EPROSIMA_TARGET)/$(DFB_TARGET_Z_LINK)
