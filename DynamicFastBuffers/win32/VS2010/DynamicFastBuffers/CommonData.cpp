...
namespace DynamicFastBuffers
{
	...
	*/
	...
	int Typecode::checkType(tc_kind kind)//0 se puede añadir; -1 no se puede añadir por ser primitivo; -2 no se puede añadir por ser array: -3 no se puede añadir por ser complejo
	{
		switch(kind_)
		{
		case TC_NOTYPE:
