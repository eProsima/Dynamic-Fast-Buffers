...
DFB_TARGET_EXE= $(BASEDIR)/lib/$(EPROSIMA_TARGET)/HelloWorldx64.sh
...
DFB_SRC_CPPFILES= $(BASEDIR)/src/cpp/TypecodeAPI.cpp \
		  ...
		  $(BASEDIR)/examples/c++/HelloWorldDFB/HelloWorldDFB-x64Win64.cpp
...
.PHONY: hwx64 checkDFBDirectories

hwx64: checkDFBDirectories $(DFB_TARGET_EXE)
